...
/***/ function(module, exports, __webpack_require__) {
	...
	if (rootElement) {
	  var posts = JSON.parse(rootElement.dataset.posts);
	  ...
	  (0, _reactDom.render)(_react2.default.createElement(
	    ...
	    _react2.default.createElement(
	      ...
	      { store: store },
	      _react2.default.createElement(_app2.default, { posts: posts })
	    )
	  ), rootElement);
	}
	  ...
	  _createClass(App, [{
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        isAuthenticated && _react2.default.createElement(_posts2.default, { posts: this.props.posts })
	      );
	    }
	  }]);
...
/***/ function(module, exports) {
	...
	function loginUser(creds) {
	  ...
	  return function (dispatch) {
	    ...
	    return fetch('http://localhost:1337/auth/signin', config).then(function (response) {
	  ...
	  _createClass(Posts, [{
	    ...
	    value: function renderPosts() {
	      return this.props.posts.map(function (post, i) {
	        return _react2.default.createElement(
	          'div',
	          { className: 'post', key: 'post_' + i },
	          _react2.default.createElement(
	            'div',
	            { className: 'col-lg-4 text-center portfolio-box' },
	            _react2.default.createElement(
	              'div',
	              { className: 'box1' },
	              _react2.default.createElement(
